package cxsjcj.hdsx.com.network.okhttp;
...
public class OkHttpClientManager {
    ...
    //====================下面是用okhttp进行图片的请求时候的一些处理，一般人们都是直接使用第三方的东西请无视就好=======================
    public static class ImageUtils {
        /**
         * 根据InputStream获取图片实际的宽度和高度
         *
         * @param imageStream 传递进来图片的流
         * @return 返回一个图片的尺寸大小
         */
