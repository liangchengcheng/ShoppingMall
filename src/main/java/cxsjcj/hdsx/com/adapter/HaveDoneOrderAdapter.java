 ...
 * Description:
 */
public class HaveDoneOrderAdapter extends RecyclerView.Adapter<HaveDoneOrderAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public HaveDoneOrderAdapter(Context context, List<Note> dataSet) {
        mContext = context;
        mDataSet = dataSet;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tv_state.setText("等待收货中");
        holder.btn_comment.setText("确认收货");
        holder.btn_delete.setText("延长收货");
