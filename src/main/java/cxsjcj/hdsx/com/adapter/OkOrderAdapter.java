 ...
 * Description:
 */
public class OkOrderAdapter extends RecyclerView.Adapter<OkOrderAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public OkOrderAdapter(Context context, List<Note> dataSet) {
        mContext = context;
        mDataSet = dataSet;
    }
